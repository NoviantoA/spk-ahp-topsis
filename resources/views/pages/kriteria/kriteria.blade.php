...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
        <div class="card">
            <div class="mx-4 my-4 d-flex flex-column flex-md-row justify-content-between">
                <a href="{{ route('kriteria.create') }}" class="btn btn-primary mb-3 mb-md-0">+ Tambah Kriteria</a>
                <div class="d-flex-end">
                    <div class="btn-group mr-4 mb-3 mb-md-0">
                        <form action="{{ route('kriteria') }}" method="get">
                ...
                <tbody>
                    <?php $no=1; ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex">
                                <a href="{{ route('kriteria.edit', $data->kriteria_id) }}" class="btn btn-sm btn-warning mx-1"><i class="bx bx-pencil me-1"></i>Edit</a>
                            <button  data-bs-toggle="modal"
                            data-bs-target="#onboardHorizontalImageModal{{ $data->kriteria_id }}"
 ...
 id="onboardHorizontalImageModal{{ $data->kriteria_id }}"
 tabindex="-1"
 aria-hidden="true"
>
     ...
     <div class="modal-body onboarding-horizontal p-0">
       ...
       <div class="onboarding-content mb-0">
         ...
         <small class="onboarding-info">
           Dengan menghapus {{ $data->nama }}, data kriteria ini akan terhapus secara permanen.
         </small>
       </div>
     </div>
     <form method="POST" action="{{ route('kriteria.delete', $data->kriteria_id) }}">
       @csrf
       @method('DELETE')
